...
class XoverProcessor:
    ...
    def identify_bad_passes(self, currentdate: float) -> List[Dict[str, str]]:
        ...
        bad_passes = []
        ii = np.where((self.psec >= currentdate - 3600) & (self.psec <= currentdate + 86400 + 3600))[0]
    ...
    def process(self):
        ...
        formatted_results = {"date": self.date.date().isoformat(), "source": self.source, "bad_passes": bad_passes}

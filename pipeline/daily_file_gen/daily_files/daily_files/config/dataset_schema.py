...
REQUIRED_VARIABLES: dict[str, list[str]] = {
    "time": ["long_name", "standard_name", "coverage_content_type", "REFTime", "REFTime_comment"],
    "latitude": ["long_name", "standard_name", "units", "coverage_content_type", "valid_min", "valid_max"],
    "longitude": ["long_name", "standard_name", "units", "coverage_content_type", "valid_min", "valid_max"],
    "ssha": ["long_name", "standard_name", "units", "coverage_content_type", "description", "mean_sea_surface", "valid_min", "valid_max"],
    "ssha_smoothed": ["long_name", "standard_name", "units", "coverage_content_type", "description", "mean_sea_surface", "valid_min", "valid_max"],
    "dac": ["long_name", "units", "coverage_content_type", "comment", "valid_min", "valid_max"],
    "nasa_flag": ["long_name", "standard_name", "coverage_content_type", "description", "flag_values", "flag_meanings"],
    "source_flag": ["long_name", "standard_name", "comment", "flag_values", "flag_meanings"],
    "median_filter_flag": ["long_name", "standard_name", "comment", "flag_values", "flag_meanings"],
    "basin_flag": ["long_name", "coverage_content_type", "comment", "reference"],
    "basin_names_table": ["long_name", "coverage_content_type", "description", "reference"],
...
def validate_dataset(ds: xr.Dataset) -> list[str]:
    ...
    for attr in REQUIRED_GLOBAL_ATTRS:
        ...
        elif isinstance(ds.attrs[attr], str) and ds.attrs[attr] == "" and attr not in ALLOW_EMPTY_GLOBAL_ATTRS:

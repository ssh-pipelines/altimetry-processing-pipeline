...
Filename prefix is determined by the global source registry (`utilities/source_registry.py`): `{source}_alt_ref_at_v11` for reference products, `{source}_alt_hilat_at_v11` for high-latitude products.

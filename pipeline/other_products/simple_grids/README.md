...
| `simple_grids/{source}/{year}/{source}_alt_ref_simple_grid_v11_{YYYYMMDD}.nc` | Output half-degree grid (write) |
| `simple_grids/quart_deg/{source}/{year}/{source}_alt_ref_simple_grid_v11_quart_{YYYYMMDD}.nc` | Output quarter-degree grid (write, when `resolution="quart"`) |
